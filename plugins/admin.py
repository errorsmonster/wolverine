...
async def reffer(client, message):
    ...
    await m.edit(f"<b>Here is your refferal link:</b>\n{refferal_link}\n\n<b>Share this link with your friends, each time they join, you will be rewarded 10 refferal points and after 100 points you will get 1 month premium subscription.\n\n Referral Points: {referral_points}</b>",
